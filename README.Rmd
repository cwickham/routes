...
This is mostly a package to help me create [routes](routes.cwick.co.nz).  It is provided with minimal documentation and no guarantees.
...
An example of running through these steps can be found in [oregon](oregon/).  In particular the result of Knitting the steps:
