...
```{r}
color_freq_sample %>% 
  write_rds(here("{{{ shortname }}}", "color_freq_sample.rds")) %>% 
  write_csv(here("{{{ shortname }}}", "color_freq_sample.csv"))
```
...
route_pixels %>% 
  ...
  count() %>% 
  write_csv(here("{{{ shortname }}}", "route_pixels_raw_counts.csv.gz"))
```
...
```{r save-route-pixels}
route_pixels %>% 
  write_rds(here("{{{ shortname }}}", "route_pixels.rds"))
```
